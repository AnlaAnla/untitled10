...
model = YOLO("C:\Code\ML\Model\yolov8n.pt", verbose=False)

train_dir = r'C:\Code\ML\Image\yolov8_data\card_person_hand\images'
label_dir = r'C:\Code\ML\Image\yolov8_data\card_person_hand\labels'
