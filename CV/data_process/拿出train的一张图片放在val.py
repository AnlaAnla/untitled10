...
# 如果目标子目录不存在，会创建一个。
source_dir = r"D:\Code\ML\Image\_CLASSIFY\card_cls2\Serices_cls_data_yolo224\train"
dst_dir = r"D:\Code\ML\Image\_CLASSIFY\card_cls2\Serices_cls_data_yolo224\val"
num_of_move = 4
