...
class NERBertModel(nn.Module):
    ...
    def forward(self, ids, mask, token_type_ids, target_tags):
        ...
        active_labels = torch.where(active_loss, target_tags.view(-1),
...
if __name__ == '__main__':
    ...
    data = pd.read_csv(r"C:\Code\ML\Text\ner\NER dataset.csv", encoding="latin-1")
    print(data.head())
    ...
    # Train Test Split
    train_sent, val_sent, train_tag, val_tag = train_test_split(data_gr['Word'], data_gr['Tag'], test_size=0.01,
                                                                random_state=10)
